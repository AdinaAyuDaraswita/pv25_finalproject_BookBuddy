...
"")
        ...
        # Setelah semua widget dan koneksi selesai

# 1. Style khusus untuk kalender popup
        ...
        self.pushButton_3.clicked.connect(lambda: self.stackedWidget.setCurrentIndex(0))  # Manage Books
        self.pushButton_4.clicked.connect(lambda: self.stackedWidget.setCurrentIndex(1))  # Manage Members
        self.pushButton_5.clicked.connect(lambda: self.stackedWidget.setCurrentIndex(2))  # Books Borrowed

        self.stackedWidget.setCurrentIndex(0)
        self.pushButton_3.setChecked(True)


        self.pushButton.clicked.connect(self.save_book)        # Simpan
        self.pushButton_11.clicked.connect(self.edit_book)     # Edit
        self.pushButton_12.clicked.connect(self.delete_book)   # Delete
        self.pushButton_10.clicked.connect(self.search_books)  # Search
        self.load_books()  # Untuk load data saat aplikasi dibuka
    ...
    def save_book(self):
        from database import create_connection  # periksa typo: harusnya database?
    ...
    def save_member(self):
        ...
        join_date = self.dateEdit_2.date().toString("yyyy-MM-dd")  # biar rapi formatnya
    ...
    def export_to_csv(self):
        ...
        # Pilih table berdasarkan halaman aktif
        if current_index == 0:
